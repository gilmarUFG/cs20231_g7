...
var React2, import_prop_types, import_jsx_runtime, import_jsx_runtime2, _excluded, useUtilityClasses, Input, Input_default;
var init_Input = __esm({
  "node_modules/@mui/base/Input/Input.js"() {
    ...
    _excluded = ["aria-describedby", "aria-label", "aria-labelledby", "autoComplete", "autoFocus", "className", "defaultValue", "disabled", "endAdornment", "error", "id", "multiline", "name", "onClick", "onChange", "onKeyDown", "onKeyUp", "onFocus", "onBlur", "placeholder", "readOnly", "required", "startAdornment", "value", "type", "rows", "slotProps", "slots", "minRows", "maxRows"];
    ...
    Input = React2.forwardRef(function Input2(props, forwardedRef) {
      ...
      return (0, import_jsx_runtime2.jsxs)(Root, _extends({}, rootProps, {
        children: [startAdornment, (0, import_jsx_runtime.jsx)(InputComponent, _extends({}, inputProps)), endAdornment]
      }));
    });
...
//# sourceMappingURL=chunk-F23VOQD7.js.map
